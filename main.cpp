...
int main(int argc, char *argv[])
{
    if(argc>=2){
        ...
        {
    {"SKILL_Type", "BACKGROUND_RARE", "BULLDOG_Glasses", "BULLDOG_Pants", "BULLDOG_Arms", "BULLDOG_Shoes", "BULLDOG_Shirt", "BULLDOG_Necklace", "BULLDOG_Move", "BULLDOG_Ball", "SKILL_Agility_Rare", "SKILL_Defense_Rare", "SKILL_Explosiveness_Rare", "SKILL_Handling_Rare", "SKILL_XP_Rare"},
    {"SKILL_Type", "BACKGROUND_RARE", "SHAM_GOD_Glasses", "SHAM_GOD_Pants", "SHAM_GOD_Arms", "SHAM_GOD_Shoes", "SHAM_GOD_Shirt", "SHAM_GOD_Necklace", "SHAM_GOD_Move", "SHAM_GOD_Ball", "SKILL_Agility_Rare", "SKILL_Defense_Rare", "SKILL_Explosiveness_Rare", "SKILL_Handling_Rare", "SKILL_XP_Rare"},
    {"SKILL_Type", "BACKGROUND", "BETWEEN_BEHIND_THE_BACK_Glasses", "BETWEEN_BEHIND_THE_BACK_Pants", "BETWEEN_BEHIND_THE_BACK_Arms", "BETWEEN_BEHIND_THE_BACK_Shoes", "BETWEEN_BEHIND_THE_BACK_Shirt", "BETWEEN_BEHIND_THE_BACK_Move", "BETWEEN_BEHIND_THE_BACK_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "BETWEEN_CROSSOVER_Glasses", "BETWEEN_CROSSOVER_Pants", "BETWEEN_CROSSOVER_Arms", "BETWEEN_CROSSOVER_Shoes", "BETWEEN_CROSSOVER_Shirt", "BETWEEN_CROSSOVER_Move", "BETWEEN_CROSSOVER_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "SPIN_CYCLE_MOVE_Glasses", "SPIN_CYCLE_MOVE_Pants", "SPIN_CYCLE_MOVE_Arms", "SPIN_CYCLE_MOVE_Shoes", "SPIN_CYCLE_MOVE_Shirt", "SPIN_CYCLE_MOVE_Move", "SPIN_CYCLE_MOVE_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "IN_N_OUT_Glasses", "IN_N_OUT_Pants", "IN_N_OUT_Arms", "IN_N_OUT_Shoes", "IN_N_OUT_Shirt", "IN_N_OUT_Move", "IN_N_OUT_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "HESITATION_Glasses", "HESITATION_Pants", "HESITATION_Arms", "HESITATION_Shoes", "HESITATION_Shirt", "HESITATION_Move", "HESITATION_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "CROSSOVER_Glasses", "CROSSOVER_Pants", "CROSSOVER_Arms", "CROSSOVER_Shoes", "CROSSOVER_Shirt", "CROSSOVER_Move", "CROSSOVER_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "BETWEEN_THE_LEGS_Glasses", "BETWEEN_THE_LEGS_Pants", "BETWEEN_THE_LEGS_Arms", "BETWEEN_THE_LEGS_Shoes", "BETWEEN_THE_LEGS_Shirt", "BETWEEN_THE_LEGS_Move", "BETWEEN_THE_LEGS_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"},
    {"SKILL_Type", "BACKGROUND", "BEHIND_THE_BACK_Glasses", "BEHIND_THE_BACK_Pants", "BEHIND_THE_BACK_Arms", "BEHIND_THE_BACK_Shoes", "BEHIND_THE_BACK_Shirt", "BEHIND_THE_BACK_Move", "BEHIND_THE_BACK_Ball", "SKILL_Agility", "SKILL_Defense", "SKILL_Explosiveness", "SKILL_Handling", "SKILL_XP"}
