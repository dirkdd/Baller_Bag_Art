...
int main(int argc, char *argv[])
{
    if(argc>=2){
        ...
        {
    //GOAT   
    {"BACKGROUND_RARE", "BULLDOG_Glasses", "BULLDOG_Pants", "BULLDOG_Arms", "BULLDOG_Shoes", "BULLDOG_Shirt", "BULLDOG_Necklace", "BULLDOG_Move", "BULLDOG_Ball","GOAT_Range", "GOAT_XP"},
    {"BACKGROUND_RARE", "SHAM_GOD_Glasses", "SHAM_GOD_Pants", "SHAM_GOD_Arms", "SHAM_GOD_Shoes", "SHAM_GOD_Shirt", "SHAM_GOD_Necklace", "SHAM_GOD_Move", "SHAM_GOD_Ball","GOAT_Range", "GOAT_XP"},
    {"BACKGROUND", "BETWEEN_BEHIND_THE_BACK_Glasses", "BETWEEN_BEHIND_THE_BACK_Pants", "BETWEEN_BEHIND_THE_BACK_Arms", "BETWEEN_BEHIND_THE_BACK_Shoes", "BETWEEN_BEHIND_THE_BACK_Shirt", "BETWEEN_BEHIND_THE_BACK_Necklace", "BETWEEN_BEHIND_THE_BACK_Move", "BETWEEN_BEHIND_THE_BACK_Ball", "Range", "XP"},
    {"BACKGROUND", "BETWEEN_CROSSOVER_Glasses", "BETWEEN_CROSSOVER_Pants", "BETWEEN_CROSSOVER_Arms", "BETWEEN_CROSSOVER_Shoes", "BETWEEN_CROSSOVER_Shirt", "BETWEEN_CROSSOVER_Necklace", "BETWEEN_CROSSOVER_Move", "BETWEEN_CROSSOVER_Ball", "Range", "XP"},
    {"BACKGROUND", "HESITATION_Glasses", "HESITATION_Pants", "HESITATION_Arms", "HESITATION_Shoes", "HESITATION_Shirt", "HESITATION_Necklace", "HESITATION_Move", "HESITATION_Ball", "Range", "XP"},
    {"BACKGROUND", "IN_N_OUT_Glasses", "IN_N_OUT_Pants", "IN_N_OUT_Arms", "IN_N_OUT_Shoes", "IN_N_OUT_Shirt", "IN_N_OUT_Necklace", "IN_N_OUT_Move", "IN_N_OUT_Ball", "Range", "XP"},
